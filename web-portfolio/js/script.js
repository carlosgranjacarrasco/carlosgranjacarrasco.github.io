...
//Types JavaScript
if(document.getElementById("language").innerHTML=="Language"){
    let typed = new Typed(".multiple-text",{
        strings: ["Junior Frontend Developer","Student at uc3m"],
        typeSpeed:100,
        backSpeed:100,
        backDelay:1000,
        loop:true
    ...
    let typed = new Typed(".multiple-text",{
        strings: ["Desarrollador Web","Estudiante Universitario"],
        typeSpeed:100,
        backSpeed:100,
        backDelay:1000,
        loop:true
